...
proporcao = 25
```
Srswor amostra simples sem reposição, srswr com reposição, poisson, systematic a ordem de siza é que está no conjunto de dados
```{r}
...
summary(infert)
```
Amostragem por estratos de educação
```{r}
